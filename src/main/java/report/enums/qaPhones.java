...
public enum qaPhones {
    ...
    RedmiNote9_OS("Android version: 10.0 (MIUI 12.0.3)"),
    HuaweiP40_OS("Android version: 10.0 (EMUI 10.1)"),
    XiaomiRedmi3s_OS("Android version: 6.0.1 (MIUI 10.2.2)"),
    XiaomiMi11_OS("Android version: 11.0 (MIUI 12.0.3)"),
    POCO_X3_Pro_OS("Android version: 11.0 (MIUI 12.5.4.0)"),
